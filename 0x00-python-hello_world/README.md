task 1- Write a Shell script that runs a Python script.
...
tasks 3- Complete this source code in order to print the integer stored in the variable number, followed by Battery street, followed by a new line.
...
Tasks 4- Complete the source code in order to print the float stored in the variable number with a precision of 2 digits.
...
Tasks 5- Complete this source code in order to print 3 times a string stored in the variable str, followed by its first 9 characters.
...
Tasks 6- Complete this source code to print Welcome to Holberton School!
